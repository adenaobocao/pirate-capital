...
function card(pirate: string, tagline: string, t: {
  ...
  <text x="46" y="${H - 30}" font-family="Arial, sans-serif" font-size="13" fill="#555555">four ai pirates. real prices. every decision in the open.</text>
  <text x="${W - 46}" y="${H - 30}" font-family="Arial, sans-serif" font-size="13" font-weight="bold" fill="#0b24bb" text-anchor="end">pirate-capital.vercel.app</text>
</svg>
`;
}
